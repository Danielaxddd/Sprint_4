...
public class QuestionsTestMozilla extends BaseTestMozilla {
    private final String answer;
    private final int number;

    public QuestionsTestMozilla(String answer, int number) {
        this.answer = answer;
        this.number = number;
    }
    ...
    @Test
    public void startUpDropDownListTest(){
        ElementsOfMainPage mainPage = new ElementsOfMainPage(driver);
        mainPage.faqQuestionsTest(answer, number);
    }
}
